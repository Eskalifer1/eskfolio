...
function ProjectItem({ className, project, ...props }: PropsType) {
  return (
    <div
      className={cn(
    ...
    >
      ...
      <article className="2xl:max-w-[60%]-max-width relative mx-auto flex h-full w-full max-w-[calc(100%-40px)] items-center justify-center pt-[5vh] pb-[20vh] sm:max-w-[calc(100%-65px)] md:max-w-[70%] lg:max-w-[50%]">
        <ProjectItemInnerWrap project={project} />
      </article>
    </div>
  );
}
